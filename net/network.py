...
class CSPNet(nn.Module):
    def __init__(self):
        ...
        nn.init.kaiming_normal_(self.feat.weight)
        nn.init.kaiming_normal_(self.pos_conv.weight)
        nn.init.kaiming_normal_(self.reg_conv.weight)
        nn.init.kaiming_normal_(self.off_conv.weight)
